...
const allNavigation: NavGroup[] = [
    ...
    { name: 'Appraisals', href: '/appraisals', icon: ClipboardDocumentCheckIcon, feature: 'appraisals' },
    ...
    { name: 'Buckets', href: '/buckets', icon: BeakerIcon, feature: 'buckets' },
    {
        ...
        children: [
            ...
            { name: 'Transactions (Activity)', href: '/reports/transactions/monthly' },
            { name: 'Transactions (Cohort)', href: '/reports/transactions/cohort' },
