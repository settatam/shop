...
const { data, loading, loadWidget, setPage, setSort, setSearch, updateFilter } = useWidget('Returns\\ReturnsTable', initialParams);

// Filters - initialize from URL params
const selectedStatus = ref<string>(initialParams.status || '');
const selectedType = ref<string>(initialParams.type || '');
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            ...
            <DataTable
                ...
                :data="data"
                :loading="loading"
                bulk-action-url="/returns/bulk-action"
