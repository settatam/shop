...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Yearly', href: '/reports/transactions/yearly' },
];
...
const exportUrl = '/reports/transactions/yearly/export';
const emailUrl = '/reports/transactions/yearly/email';
</script>

<template>
    <Head title="Transactions Report - Yearly" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <!-- Data Table -->
            <ReportTable title="Yearly Transactions Data" :export-url="exportUrl" :email-url="emailUrl">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-300">Year</th>
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                            <tr v-for="row in yearlyData" :key="row.period" class="hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer" @click="viewTransactions(row)">
