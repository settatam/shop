...
const exportUrl = '/reports/transactions/daily/export';
const emailUrl = '/reports/transactions/daily/email';
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <!-- Data Table -->
            <ReportTable title="Daily Transactions Data" :export-url="exportUrl" :email-url="emailUrl">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                            <tr v-for="row in dailyData" :key="row.period" class="hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer" @click="viewTransactions(row)">
