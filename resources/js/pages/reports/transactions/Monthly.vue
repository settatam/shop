...
const breadcrumbs = computed<BreadcrumbItem[]>(() => {
    const items: BreadcrumbItem[] = [
        ...
        { title: 'Monthly', href: '/reports/transactions/monthly' },
    ];
...
<template>
    <Head title="Transactions Report - Monthly" />
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <Link
                        href="/reports/transactions/yearly"
                        class="inline-flex items-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:bg-gray-700 dark:text-white dark:ring-gray-600 dark:hover:bg-gray-600"
                    >
                        View Yearly
                    </Link>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white dark:divide-gray-700 dark:bg-gray-800">
                            <tr v-for="row in monthlyData" :key="row.period" class="hover:bg-gray-50 dark:hover:bg-gray-700 cursor-pointer" @click="viewTransactions(row)">
