...
const breadcrumbs = computed<BreadcrumbItem[]>(() => {
    const items: BreadcrumbItem[] = [
        ...
        { title: 'Weekly', href: '/reports/transactions/weekly' },
    ];
...
const exportUrl = '/reports/transactions/weekly/export';
const emailUrl = '/reports/transactions/weekly/email';
</script>

<template>
    <Head title="Transactions Report - Weekly" />
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-4">
                    <Link
                        href="/reports/transactions/daily"
            ...
            <!-- Data Table -->
            <ReportTable title="Weekly Transactions Data" :export-url="exportUrl" :email-url="emailUrl">
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-700">
                            <tr>
                                <th class="px-3 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider dark:text-gray-300">Week</th>
