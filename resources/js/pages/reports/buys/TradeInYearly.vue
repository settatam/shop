...
const exportUrl = '/reports/buys/trade-in/yearly/export';
const emailUrl = '/reports/buys/trade-in/yearly/email';
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <!-- Data Table -->
            <ReportTable title="Yearly Trade-In Buys Data" :export-url="exportUrl" :email-url="emailUrl">
