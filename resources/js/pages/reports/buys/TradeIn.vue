...
const exportUrl = '/reports/buys/trade-in/export';
const emailUrl = '/reports/buys/trade-in/email';
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <!-- Data Table -->
            <ReportTable title="Trade-In Buys Data" :export-url="exportUrl" :email-url="emailUrl">
