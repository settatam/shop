...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Monthly', href: '/reports/buys/in-store/monthly' },
];
...
const exportUrl = '/reports/buys/in-store/monthly/export';
const emailUrl = '/reports/buys/in-store/monthly/email';
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <!-- Data Table -->
            <ReportTable title="Monthly In-Store Buys Data" :export-url="exportUrl" :email-url="emailUrl">
