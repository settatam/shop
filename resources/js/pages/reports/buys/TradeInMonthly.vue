...
const exportUrl = '/reports/buys/trade-in/monthly/export';
const emailUrl = '/reports/buys/trade-in/monthly/email';
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 p-4">
            ...
            <!-- Data Table -->
            <ReportTable title="Monthly Trade-In Buys Data" :export-url="exportUrl" :email-url="emailUrl">
