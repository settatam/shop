...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Yearly', href: '/reports/buys/online/yearly' },
];
...
const exportUrl = '/reports/buys/online/yearly/export';
const emailUrl = '/reports/buys/online/yearly/email';
</script>

<template>
    <Head title="Online Buys Report (Year over Year)" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <!-- Data Table -->
            <ReportTable title="Yearly Online Buys Data" :export-url="exportUrl" :email-url="emailUrl">
