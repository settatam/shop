...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Yearly', href: '/reports/buys/in-store/yearly' },
];
...
const exportUrl = '/reports/buys/in-store/yearly/export';
const emailUrl = '/reports/buys/in-store/yearly/email';
</script>

<template>
    <Head title="In-Store Buys Report (Year over Year)" />
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-6 p-4">
            ...
            <!-- Data Table -->
            <ReportTable title="Yearly In-Store Buys Data" :export-url="exportUrl" :email-url="emailUrl">
