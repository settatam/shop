    ...
    protected function formatOrder(Order $order): array
    {
        return [
            ...
            'customer' => $order->customer ? array_merge([
                ...
                'id_issuing_state' => $order->customer->id_issuing_state,
                'id_expiration_date' => $order->customer->id_expiration_date,
                'date_of_birth' => $order->customer->date_of_birth,
                'lead_source_id' => $order->customer->lead_source_id,
                'lead_source' => $order->customer->leadSource ? [
                    'id' => $order->customer->leadSource->id,
                    'name' => $order->customer->leadSource->name,
                ] : null,
                'addresses' => $order->customer->addresses->map(fn ($addr) => [
                    'id' => $addr->id,
