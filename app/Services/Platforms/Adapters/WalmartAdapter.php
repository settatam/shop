...
class WalmartAdapter extends BaseAdapter
{
    ...
    public function publish(PlatformListing $listing): PlatformAdapterResult
    {
        ...
        return PlatformAdapterResult::failure('Walmart publishing not yet implemented');
    }

    public function unpublish(PlatformListing $listing): PlatformAdapterResult
    {
        return PlatformAdapterResult::failure('Walmart unpublishing not yet implemented');
    }

    public function end(PlatformListing $listing): PlatformAdapterResult
    {
        return PlatformAdapterResult::failure('Walmart end listing not yet implemented');
    }

    public function updatePrice(PlatformListing $listing, float $price): PlatformAdapterResult
    {
        return PlatformAdapterResult::failure('Walmart price update not yet implemented');
    }

    public function updateInventory(PlatformListing $listing, int $quantity): PlatformAdapterResult
    {
        return PlatformAdapterResult::failure('Walmart inventory update not yet implemented');
    }
    ...
    {
        return PlatformAdapterResult::failure('Walmart refresh not yet implemented');
    }
}
