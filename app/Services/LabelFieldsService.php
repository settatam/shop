    ...
    public static function getProductFields(): array
    {
        return [
            'Basic Information' => [
                ...
                'product.price_code' => 'Price Code',
                'product.barcode_label_text' => 'Custom Label Text',
                'product.attribute_line' => 'Attribute Line (all, horizontal)',
                'product.attribute_1' => 'Attribute 1 (1st from category)',
                'product.attribute_2' => 'Attribute 2 (2nd from category)',
                'product.attribute_3' => 'Attribute 3 (3rd from category)',
                'product.attribute_4' => 'Attribute 4 (4th from category)',
                'product.attribute_5' => 'Attribute 5 (5th from category)',
            ],
            'Identifiers' => [
                'product.upc' => 'UPC',
                'product.ean' => 'EAN',
        ...
        if ($type === 'product') {
            return [
                'product' => [
                    ...
                    'attribute_line' => 'ABC123, Rings, $1,299.00',
                    'attribute_1' => 'ABC123',
                    'attribute_2' => 'Rings',
                    'attribute_3' => '$1,299.00',
                    'attribute_4' => null,
                    'attribute_5' => null,
                    'metal_type' => 'Gold',
                    'metal_purity' => '14K',
