        ...
        return $this->structure()
            ...
            ->addTable(
                ...
                columns: [
                    ...
                    $this->currencyColumn('total_shopify', 'Total Shopify'),
                    $this->currencyColumn('total_reb', 'Total Reb'),
    ...
    protected function getMonthToDateData(): array
    {
        ...
        $data = $dailyData->map(function ($row) {
            return [
                ...
                'total_shopify' => $this->formatCurrency($row['total_shopify']),
                'total_reb' => $this->formatCurrency($row['total_reb']),
        ...
        if (count($data) > 0) {
            ...
            $data[] = [
                ...
                'total_shopify' => $this->formatCurrency($totals['total_shopify']),
                'total_reb' => $this->formatCurrency($totals['total_reb']),
